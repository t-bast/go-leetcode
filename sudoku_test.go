...
func TestSudoku(t *testing.T) {
	t.Run("Candidates", func(t *testing.T) {
		...
		assert.ElementsMatch(t, []byte{'1', '2', '4'}, candidates(testBoard, 0, 2))
		assert.ElementsMatch(t, []byte{'2', '3', '7'}, candidates(testBoard, 7, 2))
	})
	...
	t.Run("Verify", func(t *testing.T) {
		...
		assert.True(t, verifySudoku(testBoard))
	})
